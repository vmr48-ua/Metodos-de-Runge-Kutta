...
# locales
from edp import schrodinger_total, diffusion_total, klein_gordon_total
# externas
import numpy as np
...
T = 20.       # Tiempo total
Nt = int(2e3) # Puntos temporales
Nt_vec = np.array([2000, 5000, 10000, 20000, 50000])
